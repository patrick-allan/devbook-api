...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	retorno := &respostas.MensagemResposta{Mensagem: "usuário cadastrado com sucesso!"}
	respostas.JSON(w, http.StatusCreated, retorno)
}

// BuscarUsuarios todos os usuarios
...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("não autorizado"))
		return
	}
...
// DeletarUsuario apaga um usuario no DB
...
func SeguiUsuario(w http.ResponseWriter, r *http.Request) {
...
// PararDeSeguirUsuario permite que um usuario pare de siguir o outro
...
// BuscarSeguindo traz todos os usuário que um determinado usuario está seguindo
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	usuarioID, erro := strconv.ParseUint(parametros["usuarioID"], 10, 64)
	if erro != nil {
		respostas.Erro(w, http.StatusBadRequest, errors.New("Controller.AtualizarSenha - "+erro.Error()))
		return
	}
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("a senha atual não confiz com a senha salva"))
		return
	}
